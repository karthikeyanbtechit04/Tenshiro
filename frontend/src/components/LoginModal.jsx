...
const LoginModal = ({ isOpen, onClose, onRegisterClick }) => {
    ...
    // Use default text if missing in translations
    const welcomeText = t('auth.welcome') !== 'auth.welcome' ? t('auth.welcome') : 'Welcome Back';
    ...
    const forgotPassText = t('auth.forgotPassword') !== 'auth.forgotPassword' ? t('auth.forgotPassword') : 'Forgot password?';
    const loginBtnText = t('auth.login') !== 'auth.login' ? t('auth.login') : 'Sign In';
    const registerText = t('auth.noAccount') !== 'auth.noAccount' ? t('auth.noAccount') : "Don't have an account?";
                ...
                <>
                    ...
                    >
                        ...
                        <div style={{ textAlign: 'center', marginBottom: '0.5rem' }}>
                            ...
                            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>Log in to continue to Tenshiro</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    <Link to="/forgot-password" onClick={onClose} style={{ fontSize: '0.8rem', color: 'var(--primary)', textDecoration: 'none', fontWeight: 600 }}>{forgotPassText}</Link>
                                </div>
                                <div style={{ position: 'relative' }}>
                            ...
                            >
                                {isLoading ? 'Signing in...' : loginBtnText}
                            </button>
                        </form>
                        ...
                        <div style={{ textAlign: 'center', marginTop: '0.5rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                            {registerText} <span onClick={onRegisterClick} style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 700, cursor: 'pointer' }}>Register</span>
                        </div>
                    </motion.div>
                </>
            )}

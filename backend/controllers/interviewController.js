    ...
    try {
        ...
        const prepData = {
            ...
            readinessTest: [
                ...
                { q: "Which is better for write-heavy systems?", options: ["Read-optimized DB", "Write-optimized DB", "In-Memory DB", "Graph DB"], correct: 1 },
                { q: "What is 2+2?", options: ["3", "4", "5", "6"], correct: 1 },
                { q: "React is a...", options: ["Library", "Framework", "Language", "Database"], correct: 0 },
                { q: "Node.js runs on...", options: ["V8", "SpiderMonkey", "Chakra", "JVM"], correct: 0 }
            ],
